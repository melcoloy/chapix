    ...
    if fichier and btn_generer:
        try:
            with st.spinner("Calculs en cours..."):
                ...
                # On récupère vmax (le stock est déjà prêt grâce à la col1)
                vmax  = valeur_max(type_jeu)

                # La variable image_prete existe déjà (calculée dans col1), 
                # on passe directement à la création de la matrice
